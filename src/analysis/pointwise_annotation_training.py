...
generation_ngrams = get_ngram_overlaps(generation_filename=args.generation_file, train_filename=args.training_file, prompt_filename=args.prompt_file, gen_length=args.gen_length, max_ngram=args.max_ngram_first_pass, add_eos=args.eos)
...
# a collection of all ngrams up to length max_ngram_first_pass from these concatenated
...
if args.trimmed:
    fo_scored = open(args.generation_file + ".training_pointwise_trimmed", "w")
else:
