...
parser.add_argument("--prompt_file", help="file of prompts; omit this argument if no prompts were used", type=str, default=None)
...
parser.add_argument("--all_analyses", help="run all analyses (excludes 'random_counts'). Requires also specifying --perplexity_model.", action='store_true')
...
parser.add_argument("--supercopying_overlap", help="run analyses of how much supercopying overlaps with the training set. If you used a special EOS token, make sure to also specify that with --eos_token.", action='store_true') 
parser.add_argument("--random_counts", help="run analyses of how many times random 100-grams are repeated in the training set. If you used a special EOS token, make sure to also specify that with --eos_token.", action='store_true')
parser.add_argument("--perplexity", help="get perplexity. Requires also specifying --perplexity_model", action='store_true')
